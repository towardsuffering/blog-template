...
pubDate: 2024-08-25T05:00:00.000Z
tags:
  - Data Analytics
  - Statistics
  - R
...
## 1. Creating a Random Vector with `rnorm()`
...
## 2. Calculating Summary Statistics with `mean()` and `sd()`
...
## 3. Counting Values Based on Conditions
...
```r
sum(aVector > 1) / length(aVector)  # Proportion of elements greater than 1
```
...
## 4. Winsorizing the Data with Vectorized Operations
...
## 5. Winsorizing the Data with a For Loop
