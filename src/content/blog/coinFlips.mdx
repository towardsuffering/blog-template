...
## 1. Ensuring Reproducibility with set.seed()
...
## 2. Simulating Coin Flips with sample()
...
## 3. Accessing Specific Elements with Indexing
...
## 4. Counting Occurrences with sum() and length()
...
## 5. Analyzing Odd and Even Flip Patterns with Subsetting
