...
pubDate: 2024-08-26T09:00:00.000Z
tags:
  - Data Analytics
  - Statistics
  - R
...
## 2. Loading and Peeking at Our Data

Now, let's load our Chipotle order data and take a quick look:

```r
rm(list=ls())  # Clear the environment
chipotleOrders <- read.csv("data/orders.csv", stringsAsFactors=FALSE)
head(chipotleOrders)
```
...
3                                                                [Apple]     $3.39
4                                                                   NULL     $2.39
5 [Tomatillo-Red Chili Salsa (Hot), [Black Beans, Rice, Cheese, Sour ...    $16.98
6 [Fresh Tomato Salsa (Mild), [Rice, Cheese, Sour Cream, Guacamole, ...    $10.98
```
...
## 3. Aggregating Data by Item Name
